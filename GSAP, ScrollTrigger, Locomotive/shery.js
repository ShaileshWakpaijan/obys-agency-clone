    ...
    return (
      (() => {
        ...
        var z,
          ...
          vt = function (e) {
            return e._repeat
              ? pt(e._tTime, (e = e.duration() + e._rDelay)) * e
              : 0;
          },
          pt = function (e, t) {
          ...
          Ct = { _start: 0, endTime: Pe, totalDuration: Pe },
          Et = function e(t, n, r) {
            var i,
              a,
              o,
          ...
          Ft = function (e, t, n) {
            return N && !t && N.selector
              ...
              ? _e(e)
                ...
                ? [e]
                : []
              : Pt.call((t || Y).querySelectorAll(e), 0);
          },
          It = function (e) {
            return (
          ...
          Wt = function (e) {
            if (fe() && e) {
              ...
              Re(t, r), e.register && e.register(ir, r, Hn);
            } else e && Ut.push(e);
          },
          Zt = 255,
          Qt = {
            ...
            var e,
              ...
              p = function n(p) {
                ...
                if (
                  ...
                  for (a = 0; a < v.length; a++) v[a](g, i, _, p);
              };
            return (r = {
              time: 0,
              frame: 0,
          ...
          yn = (function () {
            ...
            return (
              ...
              (t.endTime = function (e) {
                return (
                  this._start +
                  (pe(e) ? this.totalDuration() : this.duration()) /
                    Math.abs(this._ts || 1)
                );
              }),
          ...
          return (
            ...
            (n.set = function (e, t, n) {
              return (
                ...
                new Rn(e, t, Et(this, n), 1),
                this
              );
            }),
            (n.call = function (e, t, n) {
              return yt(this, Rn.delayedCall(0, e, t), n);
            }),
            ...
            (n.render = function (e, t, n) {
              ...
              if (
                ...
                if (
                  (f !== this._time &&
                    g &&
                    ((_ += this._time - f), (e += this._time - f)),
                  (r = _),
                  (d = this._start),
                  (l = !(c = this._ts)),
                  y && (g || (f = this._zTime), (e || !t) && (this._zTime = e)),
                  this._repeat)
                ) {
                  if (
                    ((v = this._yoyo),
                ...
                if (
                  ...
                  return (this._start = d), mt(this), this.render(e, t, n);
            ...
            (n.nextLabel = function (e) {
              return void 0 === e && (e = this._time), Ht(this, Et(this, e));
            }),
            (n.previousLabel = function (e) {
              return void 0 === e && (e = this._time), Ht(this, Et(this, e), 1);
            }),
            ...
            (t.updateRoot = function (e) {
              if (
                (V._ts && ($e(V, ft(e, V)), (G = an.frame)), an.frame >= Ve)
              ) {
                Ve += $.autoSleep || 120;
                var t = V._first;
        ...
        var xn,
          ...
          Tn = function (e, t, n, r, i, a, o) {
            var s,
              ...
              v,
              p,
              f = new Hn(this._pt, e, t, 0, 1, Bn, null, i),
              m = 0,
              g = 0;
            for (
              f.b = n,
          ...
          Cn = function e(t, n, r) {
            var i,
              ...
              R = t._targets,
              P = t.parent,
              O = P && "nested" === P.data ? P.vars.targets : R,
              q = "auto" === t._overwrite && !z,
              F = t.timeline;
            if (
              (F && (!E || !_) && (_ = "none"),
              ...
              if (
                ((f = (d = R[0] ? He(R[0]).harness : 0) && g[d.prop]),
                (i = at(g, Ie)),
                A &&
                ...
                if (
                  ...
                  f && (o[d.prop] = f),
                  ut((t._startAt = Rn.set(R, o))),
                  (t._startAt._dp = 0),
                  (t._startAt._sat = t),
                  n < 0 &&
                    (B ? t._startAt.revert(qe) : t._startAt.render(-1, !0)),
                  (t._zTime = n),
                  b)
                ) {
                  if (!n) return;
              ...
              for (
                t._pt = t._ptCache = 0, x = (D && pe(x)) || (x && !D), a = 0;
                a < R.length;
                a++
              ) {
                if (
                  ((c = (l = R[a])._gsap || Ye(R)[a]._gsap),
                  (t._ptLookup[a] = v = {}),
                  ze[c.id] && Le.length && Je(),
                  (p = O === R ? a : O.indexOf(l)),
                  d &&
                    !1 !== (h = new d()).init(l, f || i, t, p, O) &&
                    ((t._pt = s =
                      new Hn(
                        t._pt,
                        l,
          ...
          An = {};
        Xe(
          Dn + ",id,stagger,delay,duration,paused,scrollTrigger",
          function (e) {
            return (An[e] = 1);
          }
        );
        var Rn = (function (e) {
          function t(t, n, r, i) {
            ...
            var o,
              ...
              h,
              v,
              p = (a = e.call(this, i ? n : ot(n)) || this).vars,
              f = p.duration,
              m = p.delay,
              g = p.immediateRender,
              _ = p.stagger,
            ...
            return (
              ...
              (g ||
                (!f &&
                  ...
                  ht(I(a)) &&
                  "nested" !== w.data)) &&
                ((a._tTime = -1e-8), a.render(Math.max(0, -m) || 0)),
              S && bt(I(a), S),
              a
            );
          }
              ...
              if (p) {
                if (
                  ...
                  if (((r = m), (c = this.timeline), this._repeat)) {
                    if (((o = p + this._rDelay), this._repeat < -1 && f))
                  ...
                  (c &&
                    ...
                    this._onUpdate &&
                      !t &&
                      (f && dt(this, e, 0, n), Gt(this, "onUpdate")),
                    this._repeat &&
                      a !== s &&
                      this.vars.onRepeat &&
                      !t &&
                    ...
                    (m !== this._tDur && m) ||
                      this._tTime !== m ||
                      (f && !this._onUpdate && dt(this, e, 0, !0),
                      (e || !p) &&
                      ...
                      t ||
                        ...
                        (Gt(
                          this,
                          m === v ? "onComplete" : "onReverseComplete",
                          !0
                        ),
                        this._prom &&
                          !(m < v && this.timeScale() > 0) &&
                          this._prom()));
                }
              } else
                !(function (e, t, n, r) {
                  ...
                  if (
                    ...
                    t < 0 && dt(e, t, 0, !0),
                      ...
                      c && e._repeat && !n && e.parent && Gt(e, "onRepeat"),
                      (t >= e._tDur || t < 0) &&
                        e.ratio === l &&
                        (l && ut(e, 1),
                        n ||
                ...
                if (~d.indexOf(c[u]))
                  ...
                  o))
                    (l = i && i[s]) &&
                      ...
                      delete i[s]),
                      "all" !== a && (a[s] = 1);
              return this._initted && !this._pt && v && Xt(this), this;
            }),
            (t.to = function (e, n) {
        ...
        var Pn = function (e, t, n) {
          ...
          In = function (e, t) {
            return ce(e[t]) ? On : he(e[t]) && e.setAttribute ? Fn : Pn;
          },
          Ln = function (e, t) {
          ...
          tr = {
            ...
            exportRoot: function (e, t) {
              ...
              var n,
                ...
                i = new bn(e);
              for (
                i.smoothChildTiming = pe(e.smoothChildTiming),
                  V.remove(i),
                  i._dp = 0,
        ...
        (Rn.version = bn.version = ir.version = "3.12.2"),
          (H = 1),
          fe() && on();
        sn.Power0;
        var ar = sn.Power1,
        ...
        const pr = (
          ...
          if (e.getAttribute("src"))
            if ("video" === e.nodeName.toLowerCase()) {
              ...
              const e = new Image();
              (e.crossOrigin = "anonymous"), (e.src = x[0]), (T[0] = e);
            }
          var w = new Er();
          const M = () => {
            if ("img" !== e.nodeName.toLowerCase() && !v.slideStyle) {
              ...
              let e = Math.floor((w.scrollPos + 0.5 * g) / g) * g;
              v.scrollSnapping && w.snap(e);
              let { scrollPos: t } = w;
              t < 0 && (t = 0),
                t > 0 &&
                  t < g * (S.length - 1) &&
                  (a.currentScroll.value = t / g);
            }
          };
          if ("img" !== e.nodeName.toLowerCase()) {
            ...
            for (let t = 0; t < e.children.length; t++)
              if (
                ((x[t] = e.children[t].getAttribute("src")),
                ...
                const e = new Image();
                (e.crossOrigin = "anonymous"), (e.src = x[t]), (T[t] = e);
              }
          }
          Object.assign(a, {
            ...
            shapePosition: { value: new r.Vector2(0, 0) },
            shapeScale: { value: new r.Vector2(0.5, 0.5) },
          ...
          v.preset &&
            ...
            v.debug &&
              ...
              (R = A.addPanel({
                ...
                .addSubGroup({ label: "Shape Control", enable: !1 })
                ...
                .addPad(D, "shapePosition", {
                  label: "Shape Position",
                  onChange: () => a.shapePosition.value.set(...D.shapePosition),
                })
                .addGroup()),
              (document.querySelector(
                "body #controlKit .panel .button, #controlKit .picker .button"
              ...
              "img" !== e.nodeName.toLowerCase() &&
                1 != v.gooey &&
                R.addSelect(D, "scrollType", {
                  target: "scrollTypeIs",
                  label: "Scroll Type",
                  onChange: (e) => (a.scrollType.value = e),
                }),
              R.addCheckbox(a.masker, "value", {
                label: "Image Zoomer",
          ...
          v.slideStyle &&
            "function" == typeof v.slideStyle &&
            v.slideStyle(
              (e) => (a.currentScroll.value = e),
              (e) => (a.scrollLerp.value = e)
            ),
            v.setUniforms &&
            ...
            o.meshes.push(k),
            {
              ...
              animate: function t() {
                (k.position.y =
                  ...
                  (v.gooey && !v.slideStyle) ||
                    ((e) => {
                      if (a.currentScroll.value >= 0) {
                        (a.uScroll.value = r.MathUtils.lerp(
                          a.uScroll.value,
                          a.currentScroll.value,
                          e
                        )),
            ...
            i.classList.add("mask"),
              ...
              i.addEventListener("mouseenter", function () {
                n().to(fr, { opacity: 0, ease: n().EasePower1 }),
                  n().to(mr, { opacity: 0, ease: n().EasePower1 }),
        ...
        function yr(e, t = {}) {
          document.querySelectorAll(e).forEach(function (e) {
            e.addEventListener("mousemove", function (r) {
              ...
              n().to("#crsr", { scale: 1.5, ease: or, duration: 0.5 }),
                n().to(e, {
                  x: ur(-20, 70, a),
                  y: ur(-20, 100, o),
                  duration: t.duration || 1,
              ...
              e.addEventListener("mouseleave", function (r) {
                n().to("#crsr", { scale: 1, ease: or, duration: 0.5 }),
                  n().to(e, {
                    x: 0,
                    y: 0,
                    duration: t.duration || 1,
